...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L util_vector_logic_v2_0_5 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_37 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot coraz7_zynq_ps xil_defaultlib.coraz7_zynq_ps xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim coraz7_zynq_ps -key {Behavioral:sim_1:Functional:coraz7_zynq_ps} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c428.protoinst" -protoinst "protoinst_files/bd_0479.protoinst" -protoinst "protoinst_files/bd_0489.protoinst" -protoinst "protoinst_files/coraz7_zynq_ps.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb coraz7_zynq_ps.wdb xsim.dir libdpi.so)
