...
#
# Script generated by Vivado on Sun Apr 19 21:06:17 MDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : coraz7_zynq_ps.sh
...
#
# Usage        : coraz7_zynq_ps.sh
#                coraz7_zynq_ps.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                coraz7_zynq_ps.sh [-rerun]
#                coraz7_zynq_ps.sh [-reset_run]
#                coraz7_zynq_ps.sh [-clean]
#                coraz7_zynq_ps.sh [-reset_log]
#                coraz7_zynq_ps.sh [-help]
#
...
#                script (type 'coraz7_zynq_ps.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_22 -libname processing_system7_vip_v1_0_24 -libname xil_defaultlib -libname util_vector_logic_v2_0_5 -libname axi_datamover_v5_1_37 -libname axi_sg_v4_1_21 -libname axi_dma_v7_1_37 -libname proc_sys_reset_v5_0_17 -libname smartconnect_v1_0 -libname axi_register_slice_v2_1_36 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_22 processing_system7_vip_v1_0_24 xil_defaultlib util_vector_logic_v2_0_5 axi_datamover_v5_1_37 axi_sg_v4_1_21 axi_dma_v7_1_37 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_36)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "coraz7_zynq_ps.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./coraz7_zynq_ps.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  "../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_22 $xmvlog_opts -sv +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  "../../../../../../bd/coraz7_zynq_ps/ipshared/b16a/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_24 $xmvlog_opts -sv +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  "../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work util_vector_logic_v2_0_5 $xmvlog_opts +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  "../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/sc_util_v1_0_vl_rfs.sv" \
  "../../../../../../bd/coraz7_zynq_ps/ipshared/3d9a/hdl/sc_mmu_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_register_slice_v2_1_36 $xmvlog_opts +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/ec67/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/9a25/hdl" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/a415" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../../bd/coraz7_zynq_ps/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../../../opt/2025.2/data/rsb/busdef" +incdir+"/opt/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.coraz7_zynq_ps xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.coraz7_zynq_ps -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/luke-moy/Git_Repos/silicon-shroud/fpga/build/silicon_shroud_coraz7/silicon_shroud_coraz7.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log coraz7_zynq_ps_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./coraz7_zynq_ps.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: coraz7_zynq_ps.sh [-help]\n\
Usage: coraz7_zynq_ps.sh [-step]\n\
Usage: coraz7_zynq_ps.sh [-lib_map_path]\n\
Usage: coraz7_zynq_ps.sh [-rerun]\n\
Usage: coraz7_zynq_ps.sh [-reset_run]\n\
Usage: coraz7_zynq_ps.sh [-clean]\n\
Usage: coraz7_zynq_ps.sh [-reset_log]\n\
Usage: coraz7_zynq_ps.sh [-keep_index]\n\
Usage: coraz7_zynq_ps.sh [-noclean_files]\n\n\
