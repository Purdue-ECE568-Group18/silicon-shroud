...
//Date        : Sun Apr 19 21:06:14 2026
//Host        : luke-moy-ubuntu running 64-bit Ubuntu 24.04.4 LTS
//Command     : generate_target coraz7_zynq_ps.bd
//Design      : coraz7_zynq_ps
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "coraz7_zynq_ps,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=coraz7_zynq_ps,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "coraz7_zynq_ps.hwdef" *) 
module coraz7_zynq_ps
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  coraz7_zynq_ps_axi_dma_0_0 axi_dma_0
  ...
  coraz7_zynq_ps_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(processing_system7_0_FCLK_CLK0),
        .clk_out1(clk_wiz_0_clk_out1),
        .reset(util_vector_logic_0_Res[0]));
  coraz7_zynq_ps_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
        ...
        .S_AXI_HP1_AWADDR(smartconnect_2_M00_AXI_AWADDR),
        .S_AXI_HP1_AWBURST(smartconnect_2_M00_AXI_AWBURST),
        .S_AXI_HP1_AWCACHE(smartconnect_2_M00_AXI_AWCACHE),
        .S_AXI_HP1_AWID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP1_AWLEN(smartconnect_2_M00_AXI_AWLEN),
        .S_AXI_HP1_AWLOCK(smartconnect_2_M00_AXI_AWLOCK),
        .S_AXI_HP1_AWPROT(smartconnect_2_M00_AXI_AWPROT),
        .S_AXI_HP1_AWQOS(smartconnect_2_M00_AXI_AWQOS),
        .S_AXI_HP1_AWREADY(smartconnect_2_M00_AXI_AWREADY),
        .S_AXI_HP1_AWSIZE(smartconnect_2_M00_AXI_AWSIZE),
        .S_AXI_HP1_AWVALID(smartconnect_2_M00_AXI_AWVALID),
        .S_AXI_HP1_BREADY(smartconnect_2_M00_AXI_BREADY),
        .S_AXI_HP1_BRESP(smartconnect_2_M00_AXI_BRESP),
        .S_AXI_HP1_BVALID(smartconnect_2_M00_AXI_BVALID),
        .S_AXI_HP1_RDISSUECAP1_EN(1'b0),
        .S_AXI_HP1_RREADY(1'b0),
        .S_AXI_HP1_WDATA(smartconnect_2_M00_AXI_WDATA),
        .S_AXI_HP1_WID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP1_WLAST(smartconnect_2_M00_AXI_WLAST),
        .S_AXI_HP1_WREADY(smartconnect_2_M00_AXI_WREADY),
        .S_AXI_HP1_WRISSUECAP1_EN(1'b0),
        .S_AXI_HP1_WSTRB(smartconnect_2_M00_AXI_WSTRB),
        .S_AXI_HP1_WVALID(smartconnect_2_M00_AXI_WVALID),
        .USB0_VBUS_PWRFAULT(1'b0));
  coraz7_zynq_ps_smartconnect_0_0 smartconnect_0
  ...
  coraz7_zynq_ps_smartconnect_1_0 smartconnect_1
       (.M00_AXI_araddr(smartconnect_1_M00_AXI_ARADDR),
        ...
        .aresetn(processing_system7_0_FCLK_RESET0_N));
  coraz7_zynq_ps_smartconnect_2_0 smartconnect_2
       (.M00_AXI_awaddr(smartconnect_2_M00_AXI_AWADDR),
        ...
        .aclk(clk_wiz_0_clk_out1),
        .aresetn(processing_system7_0_FCLK_RESET0_N));
  coraz7_zynq_ps_util_vector_logic_0_0 util_vector_logic_0
       (.Op1({processing_system7_0_FCLK_RESET0_N,processing_system7_0_FCLK_RESET0_N,processing_system7_0_FCLK_RESET0_N,processing_system7_0_FCLK_RESET0_N,processing_system7_0_FCLK_RESET0_N,processing_system7_0_FCLK_RESET0_N,processing_system7_0_FCLK_RESET0_N,processing_system7_0_FCLK_RESET0_N}),
